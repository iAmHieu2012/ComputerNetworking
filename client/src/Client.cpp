...
int __cdecl main(void)
{
	...
	return 0;
	//std::string sender_email = "hieudapchailo@gmail.com";
	//std::string recipient_email = "hieughostxyz@gmail.com";
	//std::string subject = "Email with Attachment via Gmail API";
	//std::string body = "Please find the attached file.";
	//std::string file_path = "ktlt.pdf";
	//std::string file_name = "attachment.pdf";
